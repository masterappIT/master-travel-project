...
const messages = {
  en: {
    ...
    dashboard: 'Dashboard', 'operations-personnel': 'Personnel management', entries: 'Entry / exit items', income: 'Income report', expenses: 'Expense details', users: 'Users', trips: 'Trips', charters: 'Business charter', addresses: 'Recommended addresses', membership: 'Membership plans', promotions: 'Promotion settings', administrators: 'Administrators', auditLogs: 'Operation logs', adminConsole: 'ADMIN CONSOLE', operations: 'Operations', personnelManagement: 'Personnel management', vehicleManagement: 'Vehicle management', entryItems: 'Entry / exit items', incomeReport: 'Income report', expenseDetails: 'Expense details',
...
async function load() {
  ...
  try {
    ...
    if (requestedView === 'trips') trips.value = (await api('/admin/trips')).data
