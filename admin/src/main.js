...
const messages = {
  en: {
    ...
    dashboard: 'Dashboard', users: 'Users', trips: 'Trips', charters: 'Business charter', addresses: 'Recommended addresses', membership: 'Membership plans', promotions: 'Promotion settings', administrators: 'Administrators', auditLogs: 'Operation logs', adminConsole: 'ADMIN CONSOLE',
  ...
  zh: {
    ...
    dashboard: '仪表盘', users: '用户', trips: '行程', charters: '商务包车', addresses: '推荐地址', promotions: '優惠設定', administrators: '管理员账户', auditLogs: '操作日志', adminConsole: '管理控制台', refresh: '刷新',
