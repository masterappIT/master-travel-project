...
VALUES
    ('hk-airport', '香港', '香港國際機場', '離島區-香港赤臘角天路1號', true, 1, CURRENT_TIMESTAMP),
    ('hk-disney', '香港', '香港迪士尼樂園', '荃灣區-大嶼山竹篙灣', true, 2, CURRENT_TIMESTAMP),
    ('sz-airport', '大陸', '深圳寶安國際機場', '深圳市-寶安區-寶安大道', true, 3, CURRENT_TIMESTAMP),
    ('sz-bay', '大陸', '深圳灣口岸', '深圳市-南山區-東濱路', true, 4, CURRENT_TIMESTAMP),
    ('macau-airport', '澳門', '澳門國際機場', '嘉模堂區-偉龍馬路', true, 5, CURRENT_TIMESTAMP),
    ('macau-ruins', '澳門', '澳門大三巴牌坊', '花王堂區-炮台山下', true, 6, CURRENT_TIMESTAMP)
