...
<style scoped>.card{position:relative;background:#fff;border-radius:25px;box-sizing:border-box}.wallet{height:125px;box-shadow:0 4px 4px rgba(0,0,0,.25)}.stats{position:absolute;top:19px;left:39px;width:322px;display:flex;justify-content:space-between;text-align:center;font-size:14px}.stats view{display:flex;flex-direction:column;gap:2px;min-width:58px}.value{font-size:12px;font-weight:700;color:#285CFC}.wallet-divider{position:absolute;top:66px;left:10px;width:380px;border-top:1px solid #BECCE3}.wallet-link{position:absolute;top:76px;left:35px;display:flex;align-items:center;gap:19px;font-size:14px}.wallet-link image{width:34px;height:30px}.detail{position:absolute;top:78px;right:46px;color:#285CFC;font-size:14px}.detail text{font-size:22px;vertical-align:-1px}</style>
