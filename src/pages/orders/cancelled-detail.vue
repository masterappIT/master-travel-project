...
const applyStatus = () => {
  void loadOrder(cachedPageUrl.value || (typeof window !== 'undefined' ? window.location.hash : ''))
...
<style scoped>
.has-load-error > :not(.load-error) { display: none; }
