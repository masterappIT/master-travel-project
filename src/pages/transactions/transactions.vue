<template>
  <view class="page" :style="responsiveStyle">
    ...
    <view class="records-card">
      ...
      <scroll-view class="records-scroll" scroll-y :show-scrollbar="false" :scroll-with-animation="true">
        <view
...
const currencyAmount = (amount: number, currency: string) => formatOriginal(amount, currency, 2)
const summarizePayments = (payments: ClientPayment[], status: ClientPayment['status']) => {
  ...
  return summary || currencyAmount(0, 'RMB')
}
