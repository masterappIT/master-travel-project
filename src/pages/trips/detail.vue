<template>
  <view class="page" :style="responsiveStyle">
    <view class="header">
      ...
      <text v-else class="number">訂單編號：A82678634</text>
    </view>
    <template v-if="isTraveling">
      <text class="traveling-order-number">訂單編號：A82678634</text>
...
const returnTarget = ref<'profile' | 'orders'>(getOrderReturnTarget() || 'profile')
...
const goBack = () => {
  if (getOrderReturnTarget() === 'profile') return openCachedPage('/pages/trips/trips')
